...
export default function Auth({ onLoginSuccess, isDark, toggleDark }) {
  ...
  return (
    <div className={`min-h-screen flex flex-col justify-center items-center p-4 transition-colors duration-300 relative overflow-hidden ${isDark ? 'bg-gray-950' : 'bg-[#F5F7F6]'}`}>
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-[#00674F]/15 to-[#D3AF37]/10" />
