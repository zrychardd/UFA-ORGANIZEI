...
export default function Dashboard({ session }) {
  ...
  // ==================== SALVAR ALTERAÇÕES (SÓ MEXE QUANDO CONFIRMAR) ====================
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 p-[22px] grid grid-cols-1 lg:grid-cols-3 gap-[18px] overflow-auto">
          <div className="lg:col-span-2 flex flex-col gap-4">
            ...
            {/* ABA CONFIGURAÇÕES ORIGINAL (MODIFICADA EXCLUSIVAMENTE COM OS DRAFTS REATIVOS) */}
          ...
          {/* COLUNA DIREITA ORIGINAL DO SEU BACKUP */}
